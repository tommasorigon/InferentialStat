...
- Consequently, we have $M_0(\theta) < \infty$ for all $\theta$ and the [natural parameter space]{.orange} is $\tilde{\Theta} = \mathbb{R}$, which is an [open set]{.blue}. The resulting density is
$$
