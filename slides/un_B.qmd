...
- This is a somewhat [misleading]{.orange} graphical representation of [wind directions]{.blue} evolving over time. Indeed, the "spykes" are not real, as the data point 1 and 359 are, in fact, extremely similar directions.
...
- A better graphical representation, using cartesian coordinates.
