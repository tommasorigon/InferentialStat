...
Below is a list of [practical advice]{.blue} that may help you secure a [permanent position]{.orange} in academia, in statistics, in Italy.
...
1. Keep in mind that both [quality]{.blue} and [quantity]{.orange} matter. Aim to have around 3–4 submitted or published papers by the end of your Ph.D. — the more, the better.

2. Focus on a [niche trending topic]{.orange} and exploit it until it is exhausted. Make sure you are part of an [established group]{.blue} of researchers who actively promote the topic you are working on.
