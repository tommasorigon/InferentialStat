...
- [Propaedeutic]{.blue} topics that I will [not]{.orange} discuss here are:
...
5. [Do not waste time]{.orange} on activities that do not produce papers. This includes:
...
- The following is a list of concrete recommendations (easier said than done, especially about publishing on top journals) that may help you secure a [permanent position]{.blue} in [academia]{.blue}. 

- I [do not fully agree]{.orange} with those rules: there is more to pursuing a Ph.D. than just "getting a job." 

- These suggestions may change over time and do not necessarily apply to other fields.  Moreover, keep in mind academia, in the [short run]{.orange}, is also a [game of chance]{.blue}.
...
- Even if they work in the [short run]{.orange}, in the [long run]{.blue}, if the niche you decided to focus on is declining, transitioning towards different topics is hard if you have not studied anything else. 
...
::: {.column width="75%"}
- The above list of practical advice is probably [effective]{.orange} but [questionable]{.orange}. For sure, it lacks [perspective]{.blue}.

- In looking for [principles]{.blue} defining a [good researcher]{.orange}, I once again need to borrow the words of somebody else.

- [Santiago Ramón y Cajal]{.grey}  is a fascinating personality in science. He was one of the most important [neuroanatomists]{.blue} of his century. 

- Cajal was also a [thoughtful]{.orange} and inspired [teacher]{.orange}. 

- "The advice" became a vehicle for Cajal to write down the thoughts and anecdotes he would give to students and colleagues about how to make [important original contributions]{.blue} in any branch of [science]{.orange}.
