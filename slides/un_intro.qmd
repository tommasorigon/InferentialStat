...
![](img/Davison12.png){width=7in fig-align=center}

![](img/Davison13.png){width=7in fig-align=center}


## Advice for a young investigator?

- What is the take-home message from this overwhelming amount of work? Below is a list of [practical advice]{.blue} that may help you secure a [permanent position]{.orange} in academia.
...
2. Focus on a [niche trending topic]{.orange} and exploit it until it is exhausted. Make sure you are part of a larger, [established group]{.blue} of researchers who actively promote the topic you are working on.

3. Become an expert in your niche, and learn how to write about it and promote it effectively. In a nutshell, [learn]{.orange} how to [play the game]{.orange}.

4. Closely follow the [suggestions]{.blue} of your [advisor]{.blue} — they know better than you how to navigate the system and can guide you through many institutional, political, and scientific challenges.

5. [Do not wast time]{.orange} on activities that do not produce papers. This include:
    - Teaching to undergraduate students
    - Disseminating your work to the broader community
    - Studying topics not strictly related to your niche area
    - (God forbid!) being involved in administrative matters
