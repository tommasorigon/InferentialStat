...
[^caveat]: This is essentially correct, but strictly speaking, the result holds only for estimators that satisfy the condition. 
...
## Cramér-Rao: additional considerations ☠️
...
- Within such a restricted class, which includes regular exponential families, the Cramér–Rao bound holds for any estimator $\hat{\theta}$.

- See Theorem 5.15, Chap.2, @Lehmann1998 for such a refined Cramér-Rao theorem. See also note 8.6, Chap.2 in @Lehmann1998 for a detailed discussion.  
