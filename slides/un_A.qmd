...
## Asymptotic evaluations: informal intro
...
- An estimator $\hat{\theta}_n$ is [consistent]{.orange} if it converges [in probability]{.blue} to the true value $\theta$ as the sample size increases, i.e., $\hat{\theta}_n \overset{p}{\longrightarrow} \theta$ as $n\rightarrow \infty$. Classical [sufficient conditions]{.blue} are given below.
