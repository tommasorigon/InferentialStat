...
Let $Y_1,\dots,Y_n$ be a sample from a joint probability measure $f(\mathrm{d}\bm{y} \mid \theta)$ and let $\Theta = \mathbb{R}$. Moreover, let $\hat{\theta}(\bm{Y})$ be an estimator of $\theta$ satisfying
$$
1 + b^*(\theta) := \frac{\partial}{\partial \theta}\int \hat{\theta}(\bm{y})f(\mathrm{d}\bm{y} \mid \theta) = \int \frac{\partial}{\partial \theta} \hat{\theta}(\bm{y})f(\mathrm{d}\bm{y} \mid \theta),
$$
...
Let $Y_1,\dots,Y_n$ be a sample from a joint probability measure $f(\mathrm{d}\bm{y} \mid \theta)$ and let $\Theta = \mathbb{R}$. If we can interchange derivation and integration, namely
$$\frac{\partial}{\partial \theta}\int f(\mathrm{d}\bm{y} \mid \theta) = \int \frac{\partial}{\partial \theta} f(\mathrm{d}\bm{y} \mid \theta),
$$
then 
$$
...
Let $Y_1,\dots,Y_n$ be a sample from a joint probability measure $f(\mathrm{d}\bm{y} \mid \theta)$ and let $\Theta = \mathbb{R}$. If we can interchange [twice]{.orange} derivation and integration
$$\frac{\partial}{\partial \theta}\int f(\mathrm{d}\bm{y} \mid \theta) = \int \frac{\partial}{\partial \theta} f(\mathrm{d}\bm{y} \mid \theta),
$$
and
$$
...
## Cramér-Rao: miscellanea

- Attainance and exponential families
