...
## Example: Huber estimators for regression I 📖
...
## Example: Huber estimators for regression II 📖

- Let $Z \sim \tilde{f}_0$, and note such density [does not depend]{.orange} on $\theta_0$. After some calculations, we find
$$
j(\theta) = \mathbb{E}_0\{q^2(Y_1 - \theta)\}= \mathbb{E}\{Z^2 I(|Z|< k)\} + 2 k^2 \mathbb{P}(Z > k),
$$
and
$$
