...
|Name  | At Bats $n_i$ | Hits $x_i$ |  Avg. $\hat{p_i}$ | James-Stein| Rem. avg.|
|:---|---------------:|-------------:|-----------------:|----------------:|---------------:|
...
- The [shrinkage effect]{.orange} is evident and provides a better estimate of the [remaining average]{.blue} for the season.  
